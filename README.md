...
This repository accompanies my training session **An Introduction to Bayesian Regression in Stan**. The materials are described in the slide deck *Stan_tutorial_June2026.pdf*
